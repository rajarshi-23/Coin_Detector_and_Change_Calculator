...
while True:
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            label = '%s: %d%%' % (object_name, int(scores[i]*100)) # Example: 'Two: 94%'
            ...
            if object_name == 'One':
                this_coin_value = 1
            elif object_name == 'Two':
                this_coin_value = 2
            elif object_name == 'Five':
                this_coin_value = 5
            elif object_name == 'Ten':
                this_coin_value = 10
    ...
    cv2.putText(frame,'Rs. %.2f' % total_coin_value,(260,85),cv2.FONT_HERSHEY_PLAIN,2.5,(0,0,0),4,cv2.LINE_AA)
    cv2.putText(frame,'Rs. %.2f' % total_coin_value,(260,85),cv2.FONT_HERSHEY_PLAIN,2.5,(85,195,105),2,cv2.LINE_AA)
